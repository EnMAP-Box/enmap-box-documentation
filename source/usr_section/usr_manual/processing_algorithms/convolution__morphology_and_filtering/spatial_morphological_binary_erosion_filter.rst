...
2. Select the corresponding filter under :guilabel:`EnMAP-Box > convolution, morphology and filtering > Spatial morphological Binary Erosion filter`.

    .. figure:: ./img/binary_erosion_filter_location.png
       :align: center
