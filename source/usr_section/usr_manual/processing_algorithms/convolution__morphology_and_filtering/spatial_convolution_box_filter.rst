...
:guilabel:`Kernel` [string]
    Python code. See `Box2DKernel <https://docs.astropy.org/en/stable/en/stable/api/astropy.convolution.Box2DKernel.html>`_ for information on different parameters.
