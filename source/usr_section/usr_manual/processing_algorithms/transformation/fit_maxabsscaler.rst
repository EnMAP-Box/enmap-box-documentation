...
.. include:: ../../processing_algorithms_includes/transformation/fit_maxabsscaler.rst
...
:guilabel:`Transformer` [string]
    Scikit-learn python code. See `MaxAbsScaler <https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.MaxAbsScaler.html>`_ for information on different parameters.
