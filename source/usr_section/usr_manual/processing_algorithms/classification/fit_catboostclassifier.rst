...
Implementation of the scikit-learn API for <a href="https://catboost.ai/en/docs/">CatBoost</a> <a href="https://enmap-box.readthedocs.io/en/latest/general/glossary.html#term-classifier">classifier</a>.
...
:guilabel:`Classifier` [string]
    Scikit-learn python code. See <a href="https://catboost.ai/en/docs/concepts/python-reference_catboostclassifier">CatBoostClassifier</a> for information on different parameters.
    Default::
