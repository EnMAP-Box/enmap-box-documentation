...
2. If still undefined, search in GDAL band metadata. Search first within the IMAGERY, standard and ENVI domains:
...
3. If still undefined, search GDAL dataset metadata. Search first within the standard and ENVI domain:
